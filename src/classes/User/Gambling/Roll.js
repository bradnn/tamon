/**
 * @file Roll module for the Gambling Contianer.
 * @author sycles
 * @version 1.1.1
 * @since 1.1.1
 */
...
module.exports = class {
     ...
     * 
     * @class
     * @classdesc Roll module for the Gambling Contianer.
     * 
    ...
    /**
     * Returns the total amount a user has won from using the roll command.
     * 
     * @returns {number} Total coins won.
     */
    getAmountWon() {
        return user.profile.commands.gambling.roll.amountWon;
    }

    /**
     * Returns the total amount a user has lost from using the roll command.
     * 
     * @returns {number} Total coins lost.
     */
    getAmountLost() {
        return user.profile.commands.gambling.roll.amountLost;
    }
     ...
     */
    getWins() {
        return user.profile.commands.gambling.roll.wins;
    }
     ...
     */
    addWins(amount = 1) {
        user.profile.commands.gambling.roll.wins += amount;
        return user.profile.commands.gambling.roll.wins;
    }
     ...
     */
    getLosses() {
        return user.profile.commands.gambling.roll.losses;
    }
     ...
     */
    addLoss(amount = 1) {
        user.profile.commands.gambling.roll.losses += amount;
        return user.profile.commands.gambling.roll.losses;
    }
     ...
     */
    getLargestWin() {
        return user.profile.commands.gambling.roll.largestWin;
    }
